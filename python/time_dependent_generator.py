...
ax.plot(*data_hi, 'g-', alpha = 1, label = 'sample = '+str(len(data_hi[0])));
ax.plot(*data_mid, 'y.--', alpha = 0.7, label = 'sample = '+str(len(data_mid[0])));
ax.plot(*data_low, 'r.--', alpha = 0.5, label = 'sample = '+str(len(data_low[0])));
